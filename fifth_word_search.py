...
# === Load wordlist and byte 5 ===
wordlist = load_bip39_wordlist()
y1_byte5 = words_to_bytes(share_A, wordlist)[4]
y2_byte5 = words_to_bytes(share_B, wordlist)[4]

# === Paste your four-word paths here ===
four_word_paths = [
    ('audit', 'quote', 'length', 'abandon'), ('august', 'marine', 'length', 'abandon'), ('aunt', 'mosquito', 'length', 'abandon'), ('author', 'marine', 'length', 'abandon'), ('auto', 'useless', 'length', 'abandon'), ('autumn', 'avoid', 'length', 'abandon'), ('average', 'source', 'length', 'abandon'), ('avocado', 'mosquito', 'length', 'abandon'), ('elite', 'quote', 'length', 'abandon'), ('else', 'marine', 'length', 'abandon'), ('embark', 'mosquito', 'length', 'abandon'), ('embody', 'marine', 'length', 'abandon'), ('embrace', 'useless', 'length', 'abandon'), ('emerge', 'avoid', 'length', 'abandon'), ('emotion', 'source', 'length', 'abandon'), ('employ', 'mosquito', 'length', 'abandon'), ('length', 'quote', 'length', 'abandon'), ('lens', 'marine', 'length', 'abandon'), ('leopard', 'mosquito', 'length', 'abandon'), ('lesson', 'marine', 'length', 'abandon'), ('letter', 'useless', 'length', 'abandon'), ('level', 'avoid', 'length', 'abandon'), ('liar', 'source', 'length', 'abandon'), ('liberty', 'mosquito', 'length', 'abandon'), ('orchard', 'quote', 'length', 'abandon'), ('order', 'marine', 'length', 'abandon'), ('ordinary', 'mosquito', 'length', 'abandon'), ('organ', 'marine', 'length', 'abandon'), ('orient', 'useless', 'length', 'abandon'), ('original', 'avoid', 'length', 'abandon'), ('orphan', 'source', 'length', 'abandon'), ('ostrich', 'mosquito', 'length', 'abandon'), ('reduce', 'quote', 'length', 'abandon'), ('reflect', 'marine', 'length', 'abandon'), ('reform', 'mosquito', 'length', 'abandon'), ('refuse', 'marine', 'length', 'abandon'), ('region', 'useless', 'length', 'abandon'), ('regret', 'avoid', 'length', 'abandon'), ('regular', 'source', 'length', 'abandon'), ('reject', 'mosquito', 'length', 'abandon'), ('slot', 'quote', 'length', 'abandon'), ('slow', 'marine', 'length', 'abandon'), ('slush', 'mosquito', 'length', 'abandon'), ('small', 'marine', 'length', 'abandon'), ('smart', 'useless', 'length', 'abandon'), ('smile', 'avoid', 'length', 'abandon'), ('smoke', 'source', 'length', 'abandon'), ('smooth', 'mosquito', 'length', 'abandon'), ('unfair', 'quote', 'length', 'abandon'), ('unfold', 'marine', 'length', 'abandon'), ('unhappy', 'mosquito', 'length', 'abandon'), ('uniform', 'marine', 'length', 'abandon'), ('unique', 'useless', 'length', 'abandon'), ('unit', 'avoid', 'length', 'abandon'), ('universe', 'source', 'length', 'abandon'), ('unknown', 'mosquito', 'length', 'abandon'), ('vital', 'quote', 'length', 'abandon'), ('vivid', 'marine', 'length', 'abandon'), ('vocal', 'mosquito', 'length', 'abandon'), ('voice', 'marine', 'length', 'abandon'), ('void', 'useless', 'length', 'abandon'), ('volcano', 'avoid', 'length', 'abandon'), ('volume', 'source', 'length', 'abandon'), ('vote', 'mosquito', 'length', 'abandon')
]

print("🔍 Starting fifth-word search...\n")
five_word_paths = []

for first, second, third, fourth in four_word_paths:
    best_score = 0
    best_fifth = None

    for fifth in wordlist:
        guess_mnemonic = f"{first} {second} {third} {fourth} {fifth} " + "abandon " * 7
        try:
            guess_bytes = words_to_bytes(guess_mnemonic.strip(), wordlist)
        except KeyError:
            continue

        y3_byte5 = guess_bytes[4]
        x3 = 3
        points = [(x1, y1_byte5), (x2, y2_byte5), (x3, y3_byte5)]
    ...
    if best_fifth:
        five_word_paths.append((first, second, third, fourth, best_fifth))
        print(f"✅ {first} {second} {third} {fourth} {best_fifth} → score={best_score}")

print("\n🎯 Phase 5 complete. Review valid five-word paths above.")